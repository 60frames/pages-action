...
try {
	...
	const createPagesDeployment = async () => {
		console.log(`Creating Pages Deployment from 60frames`);
    ...
    $$ npx wrangler@${wranglerVersion} pages deploy "${directory}" --project-name="${projectName}" --branch="${branch} --no-bundle --skip-caching"
    `;
