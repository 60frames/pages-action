...
try {
	...
	const createPagesDeployment = async () => {
		console.error(`Creating Pages Deployment from 60frames`);
    ...
    $$ npx wrangler@${wranglerVersion} pages publish "${directory}" --project-name="${projectName}" --branch="${branch} --no-bundle"
    `;
